...
<body>
    ...
    <section class>
        <div class="container">
            <h1 class="hero-heading2"> Fender guitar straps </h1>
    ...
    <section class="all-section artists-section">
        <div class="container artists">
            <div class="artists-cnt-wrapper"><img src="public/product_img/Fender Guitar Strap.webp" alt="strap"></div>
            <div class="artists-cnt-wrapper">
                <h3 class="artists-heading2">Current price:  </h3>
                   <h4 class="artists-heading3"> 29.99$ </h4>
                <h3 class="artist-heading2"> About item: </h3>   
                <p class="artists-txt">The Fender elastic guitar strap takes the weight off your shoulders, so you can focus on what’s important—expressing your creativity. Sporting inimitable Fender style, this unique strap was designed by players, for players, with exceptional comfort in mind.</p>
