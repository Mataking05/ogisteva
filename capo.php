...
<body>
    ...
    <section class>
        <div class="container">
            <h1 class="hero-heading2"> Guitar capo </h1>
    ...
    <section class="all-section artists-section">
        <div class="container artists">
            <div class="artists-cnt-wrapper"><img src="public/product_img/capocut.png" alt="fender"></div>
            <div class="artists-cnt-wrapper">
                <h3 class="artists-heading2">Current price:  </h3>
                   <h4 class="artists-heading3"> 14.99$ </h4>
                <h3 class="artist-heading2"> About item: </h3>   
                <p class="artists-txt">The guitar capo allow guitarists to easily play in different keys. And you can easily release and reposition it with one hand without disturbing the tuning. Perfect for stage performance and practice. The medium gauge guitar pick works well for strumming and articulate picking. The wide body shape and rounded tip prevent chipping and it fits your fingers perfectly.</p>
